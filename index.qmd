...
::: {.callout-caution title="Group Assignment (Tentative)" collapse="false"}
Deadline (TBA)
Use Global Dietary Database and prepare a brief exploratory data analysis using `dplyr` and `ggplot2`.

+ [Global Dietary Database (Nutrition)](https://www.globaldietarydatabase.org/)
    + [Data](https://www.globaldietarydatabase.org/data-download)
:::
