...
::: {.callout-caution title="Assignment 1" collapse="false"}
...
3. Watch some UseR-2022 videos (Main Link - Recordings Link) and write one of them down on your RMarkdown/Quarto document. Alternatively you can check RStudio Global 2022 conference talks.
4. Find 3 R posts relevant to your interests and describe them. Get the html output and put it in your progress journal repository.
5. Provide a link from your Progress Journal page.
